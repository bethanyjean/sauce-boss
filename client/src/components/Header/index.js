...
import coverImage from '../../assets/Group.jpeg'
  ...
  <nav className="bg-red border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
    <div className="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div className='bg-red' >
        <img alt='gallery' className='object-center h-24' src={coverImage}/>
      </div>

      <div className="w-full md:block md:w-auto" id="navbar-default">

        <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-xl md:font-semibold md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 block py-2 pr-4 pl-3 text-gray-700 rounded">
          <li>
